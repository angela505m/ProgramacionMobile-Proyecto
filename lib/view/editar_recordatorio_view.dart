...
class _EditarRecordatorioViewState extends State<EditarRecordatorioView> {
  ...
  Widget build(BuildContext context) {
    ...
    // Si el recordatorio es de medicamento y el usuario no es premium, cerrar pantalla
    if (widget.recordatorio.tipo == 'medicamento' && !usuarioVM.esPremium) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        Navigator.pop(context);
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Los medicamentos son solo para Premium')),
        );
      });
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  ...
                  const DropdownMenuItem(value: 'paseo', child: Text('Paseo')),
