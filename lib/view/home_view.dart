...
import 'premium_offer_view.dart'; // ✅ import pantalla premium
...
class _HomeViewState extends State<HomeView> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (idUsuario != null) {
        ...
        await Provider.of<MascotaViewModel>(context, listen: false)
            .cargarMascotas(idUsuario);

        // Obtener y guardar token FCM
        final fcmToken = await FirebaseMessaging.instance.getToken();
        if (fcmToken != null) {
          await usuarioVM.guardarTokenFCM(fcmToken);
        }
      }
    });
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          // ✅ Botón para mejorar a Premium (solo si NO es premium)
          if (!usuarioVM.esPremium)
            IconButton(
              icon: const Icon(Icons.star_border, color: Colors.amber),
              tooltip: 'Mejorar a Premium',
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const PremiumOfferView()),
                );
              },
            ),
          Padding(
          ...
          IconButton(
            icon: const Icon(Icons.watch, color: Color(0xFF96C9F2)),
            onPressed: () {
              Navigator.push(
                context,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ Banner de anuncio simulado (solo si NO es premium)
              if (!usuarioVM.esPremium)
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.ad_units, color: Colors.orange),
                        const SizedBox(width: 10),
                        const Expanded(
                          child: Text(
                            'Anuncio - Versión gratuita. Mejora a Premium sin anuncios y con medicamentos.',
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => const PremiumOfferView()),
                            );
                          },
  ...
  // ========== TODOS LOS MÉTODOS EXISTENTES (CON FILTRO PREMIUM EN RECORDATORIOS) ==========
  ...
  // ✅ Diálogo de recordatorio con filtro premium
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            // Validación extra de premium para medicamento
                            if (selectedTipo == 'medicamento' &&
                                !usuarioVM.esPremium) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text(
                                        'Los medicamentos son solo para Premium')),
                              );
                              return;
                            }
                            final novaHora =
...
// ------------------------------------------------------------
// Widget _RecordatoriosList (sin cambios, pero ya funciona)
// ------------------------------------------------------------
              ...
              Row(
                ...
                children: [
                  Switch(
                    ...
                    activeThumbColor: const Color(0xFF96C9F2),
