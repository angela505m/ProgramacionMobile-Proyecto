...
import 'premium_offer_view.dart';
import 'politica_privacidad_view.dart'; // ✅ importar nueva pantalla
...
class _CrearCuentaViewState extends State<CrearCuentaView> {
  ...
  void _mostrarPoliticaPrivacidad(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (ctx) => PoliticaPrivacidadView(
          onAccept: (aceptado) async {
            if (aceptado) {
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.asset('assets/logo.png',
                      height: logoSize, fit: BoxFit.cover),
                ),
