...
class _ConfiguracionViewState extends State<ConfiguracionView> {
  ...
  Future<void> _eliminarCuenta() async {
    final userVM = Provider.of<UsuarioViewModel>(context, listen: false);
    final emailActual = userVM.usuarioEmail ?? '';
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text(
                  'Para eliminar tu cuenta permanentemente, escribe tu email:'),
              ...
              const Text('Motivo de la eliminación:'),
              ...
              DropdownButtonFormField<String>(
                ...
                items: motivos
                    ...
                    .toList(),
                onChanged: (val) => selectedMotivo = val,
    ...
    if (emailController.text.trim() != emailActual) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('El email ingresado no coincide con tu cuenta.')),
      );
      return;
    }

    // Aquí podrías enviar el motivo a un servidor (log) antes de eliminar.
    // Por ahora solo lo mostramos en consola.
    print('Motivo de eliminación: $selectedMotivo');
